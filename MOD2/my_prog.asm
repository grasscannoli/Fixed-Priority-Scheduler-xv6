...
main(int argc, char *argv[])
{
  ...
  int pid;
  pid = getpid();
   f:	e8 1d 03 00 00       	call   331 <getpid>
  int prio;
  ...
  prio = getpriority(pid);
  1a:	e8 3a 03 00 00       	call   359 <getpriority>
  ...
  31:	6a 03                	push   $0x3
  33:	53                   	push   %ebx
  34:	e8 28 03 00 00       	call   361 <setpriority>
  prio = getpriority(pid);
  39:	89 1c 24             	mov    %ebx,(%esp)
  3c:	e8 18 03 00 00       	call   359 <getpriority>
  printf(1, "final priority: %d\n", prio);
  41:	83 c4 0c             	add    $0xc,%esp
  44:	50                   	push   %eax
  45:	68 ae 07 00 00       	push   $0x7ae
  4a:	6a 01                	push   $0x1
...
00000359 <getpriority>:
SYSCALL(getpriority)
 359:	b8 17 00 00 00       	mov    $0x17,%eax
 35e:	cd 40                	int    $0x40
 360:	c3                   	ret    

00000361 <setpriority>:
SYSCALL(setpriority)
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb c2 07 00 00       	mov    $0x7c2,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d 78 0a 00 00    	mov    0xa78,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	8b 15 78 0a 00 00    	mov    0xa78,%edx
